...
public class PathGenerator {
    ...
    public static Trajectory generateTrajectory(path path, boolean readFromCSV) {
        ...
        String leftTwoIntakeStation = "/home/lvuser/deploy/paths/leftTwoIntakeStation.pf1.csv";
        ...
        try {
            switch (path) {
                ...
                case RIGHT_LEVEL_2:
                    ...
                    trajectory = Pathfinder.readFromCSV(file);
                    break;
                case LEFT_TWO_INTAKE_STATION:
                    file = new File(leftTwoIntakeStation);
                    trajectory = Pathfinder.readFromCSV(file);
                    break;
                default:
