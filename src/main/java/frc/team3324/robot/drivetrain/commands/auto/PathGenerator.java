...
public class PathGenerator {
    ...
    public static Trajectory generateTrajectory(path path, boolean readFromCSV) {
        ...
        Trajectory.Config config = new Trajectory.Config(
            Trajectory.FitMethod.HERMITE_CUBIC, Trajectory.Config.SAMPLES_FAST, 0.01,
            Constants.DriveTrain.HIGH_GEAR_MAX_VELOCITY,
            Constants.DriveTrain.HIGH_GEAR_MAX_ACCELERATION, 9);
