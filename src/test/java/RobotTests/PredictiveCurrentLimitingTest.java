...
public class PredictiveCurrentLimitingTest {
  ...
  private boolean checkPredictedGreaterThan(double predictedVoltage, double testVoltage) {
    return predictedVoltage > testVoltage;
  }

  private boolean checkTestGreaterThan(double predictedVoltage, double testVoltage) {
    return predictedVoltage < testVoltage;
  }

  private boolean checkTestEqual(double predictedVoltage, double testVoltage) {
    return predictedVoltage == testVoltage;
  }
