...
import static frc.team3324.robot.DriveTrain.Commands.Auto.PathGenerator.generateTrajectory;
...
public class JaciPathfinding extends Command {
    ...
    private void followReversed() {
        ...
        angleDifference = Pathfinder.boundHalfDegrees(desiredHeading - gyroHeading);
        turn = 1.2 * (-1.0 / 80.0) * angleDifference;
        Robot.mDriveTrain.mDrive.tankDrive(-(rOutput - turn), -(lOutput + turn), false);
