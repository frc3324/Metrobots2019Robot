...
public class OI {
    ...
    public static final Button SECONDARY_B_BUTTON =
        new JoystickButton(secondaryController, BUTTON_B);
    public static final Button SECONDARY_X_BUTTON =
        new JoystickButton(secondaryController, BUTTON_X);
    public static final Button SECONDARY_Y_BUTTON =
        new JoystickButton(secondaryController, BUTTON_Y);
    public static final Button SECONDARY_BACK_BUTTON =
        new JoystickButton(secondaryController, BUTTON_BACK);
    public static final Button SECONDARY_START_BUTTON =
        new JoystickButton(secondaryController, BUTTON_START);
    ...
    public static final Button SECONDARY_LEFT_BUMPER =
        new JoystickButton(secondaryController, LEFT_BUMPER);
    public static final Button SECONDARY_RIGHT_BUMPER =
        new JoystickButton(secondaryController, RIGHT_BUMPER);
